        ...
        <div class="mb-8 px-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 pl-11">Kelola data layanan jahit</p>
                </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Estimasi</th>
