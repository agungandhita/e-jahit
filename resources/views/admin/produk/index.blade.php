                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jumlah Produksi</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($produk as $index => $item)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <span class="{{ $item->jumlah_produksi <= 5 ? 'text-red-600 font-semibold' : 'text-gray-900' }}">
